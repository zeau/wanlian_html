<template>
    <div class="bottomF">
        <div class="wp">
            <div class="row">
                <div class="col-6"><i class="icons icon_bt_01"></i>
                    正品保障
                    <div>海外直采货源透明</div>
                </div>
                <div class="col-6"><i class="icons icon_bt_02"></i>
                    闪电发货
                    <div>电子清关保税仓直发</div>
                </div>
                <div class="col-6"><i class="icons icon_bt_03"></i>
                    政府保障
                    <div>国检监督海关备案</div>
                </div>
                <div class="col-6"><i class="icons icon_bt_04"></i>
                    无忧售后
                    <div>国内售后七天包退</div>
                </div>
            </div>
            ...
            <div class="service  clearfix">
                <dl class="svc_box fl">
                    <dt>购物指南</dt>
                    <dd>
                        <div><router-link :to="{name:'Help',params: {userTitle:123}}" target="_blank">用户注册</router-link></div>
                        <div><router-link :to="{name:'Help',params: {title:'账户安全'}}" target="_blank">账户安全</router-link></div>
                        <div><router-link :to="{name:'Help',params: {title:'联系客服'}}" target="_blank">联系客服</router-link></div>
                        <div><router-link :to="{name:'Help',params: {title:'购物流程'}}" target="_blank">购物流程</router-link></div>
                    </dd>
                </dl>
                <dl class="svc_box fl">
                    <dt>帮助中心</dt>
